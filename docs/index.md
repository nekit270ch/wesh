...
### Расширения
Расширения - программы на C#, использующие API wesh для расширения его возможностей.
...
`gui.addElemItem <id combobox>, <текст>` - добавить в список ComboBox элемент с указанным текстом.
