...
`whilee [!], <команда>, <блок кода>` - пока результат выполнения команды равен `true`, выполнять блок кода. Если первым аргументом указан восклицательный знак, то блок кода выполняется, пока рузультат выполнения команды равен `false`, а не `true`.
